...
<div class="demo-block vp-raw"><div class="demo-mobile">
  <weui-form title="原生选择框">
    <weui-cell-group form>
      <weui-cells>
        <weui-select v-model="selectValue"><option value="1">微信号</option><option value="2">QQ号</option><option value="3">Email</option></weui-select>
        <weui-select v-model="selectAfterValue" label="国家"><option value="1">中国</option><option value="2">美国</option><option value="3">英国</option></weui-select>
      </weui-cells>
    </weui-cell-group>
  </weui-form>
</div></div>
...
<div class="demo-block vp-raw"><div class="demo-mobile">
  <weui-form title="文本域" desc="输入更多内容的输入区域样式展示。">
    <weui-cell-group form>
      <weui-cells title="问题描述"><weui-textarea v-model="textareaValue" placeholder="请描述你所发生的问题" /></weui-cells>
    </weui-cell-group>
  </weui-form>
</div></div>
...
<div class="demo-block vp-raw"><div class="demo-mobile">
  <weui-form title="上下结构" desc="上下结构样式。">
    <weui-cell-group form>
      <weui-cells><weui-textarea label="问题描述" vertical placeholder="请描述你所发生的问题" /></weui-cells>
    </weui-cell-group>
  </weui-form>
</div></div>
